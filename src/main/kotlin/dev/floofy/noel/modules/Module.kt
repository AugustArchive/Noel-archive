...
import dev.floofy.noel.modules.wahs.RedPandaModule
import org.koin.dsl.module

val modules = module {
    single { RedPandaModule(get()) }
    single { MongoModule(get()) }
    single { DiscordModule(get(), get()) }
    single { CommandsModule(get(), get()) }
}
